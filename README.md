...
A production-inspired URL shortening service built with Spring Boot, PostgreSQL, and Redis.
The project is designed in two phases to demonstrate clean architecture, caching strategy, rate limiting, asynchronous processing, and backend engineering fundamentals.
...
This URL Shortener converts long URLs into compact short URLs that can be used for redirection.
The project is implemented in two phases:

- **Phase 1** — Core URL Shortening.

- **Phase 2** — Performance, Caching & Observability.

The system uses PostgreSQL for persistent storage and Redis for caching and rate limiting.
...
![project-structure (2).png](project-structure%20%282%29.png)
